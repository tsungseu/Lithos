...
window.installLithosNavigation = W => {
 ...
 const knowledge=node('details',undefined,'ws-knowledge-root');knowledge.open=true;knowledge.append(node('summary',state.knowledgeName||'技术知识库'),E.tree);files.append(knowledge);
