...
PACKAGE = OUT / '曜石-Lithos-v3.2.0-Windows-x64'
FILES = ['office-frame.html','office-frame.js','office.css','server.py','launcher.py','index.html','workspace.css','shell.js','style.css','app.js','settings.js','graph.js','storage.js','router.js','providers.js','启动工作台.cmd','使用说明.md','离线使用与配置.md','项目记录模板.md']
...
def build():
    ...
    shutil.copytree(BASE/'vendor',PACKAGE/'vendor',dirs_exist_ok=True)
